...
function submit() {
    ...
    form.post(`/guard-change/${activeReq.value.id}/final-approve`, { onSuccess: () => closeModal() });
}
...
<template>
    <AppLayout title="อนุมัติคำขอเปลี่ยนยาม (ผอ.)">
        <div class="premium-wrapper min-h-screen -m-4 md:-m-8 pb-32 relative overflow-hidden bg-[#f8fafc] font-sans selection:bg-rose-200">
            <!-- Animated Liquid Background Shapes -->
            <div class="fixed inset-0 pointer-events-none overflow-hidden z-0">
                <div class="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-rose-400/20 rounded-full blur-[80px] mix-blend-multiply animate-blob"></div>
                <div class="absolute top-[30%] left-[-10%] w-[500px] h-[500px] bg-amber-400/20 rounded-full blur-[80px] mix-blend-multiply animate-blob animation-delay-2000"></div>
                <div class="absolute bottom-[-10%] right-[10%] w-[700px] h-[700px] bg-orange-300/20 rounded-full blur-[100px] mix-blend-multiply animate-blob animation-delay-4000"></div>
            </div>
            ...
            <div class="relative z-10 max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8 pt-12">
                ...
                <div class="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6"
                    ...
                    <div>
                        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-badge mb-6 shadow-sm border border-rose-100/50">
                            <span class="relative flex h-2.5 w-2.5">
                                <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-rose-400 opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-2.5 w-2.5 bg-rose-500"></span>
                            </span>
                            <span class="text-rose-700 text-[11px] font-black uppercase tracking-[0.2em]">การพิจารณาของ ผอ. (ขั้นสุดท้าย)</span>
                        </div>
                        <div class="flex items-center gap-4 mb-3">
                            <div class="w-14 h-14 bg-gradient-to-br from-rose-500 to-orange-600 rounded-[1.25rem] flex items-center justify-center shadow-lg shadow-rose-500/30 border border-white/20">
                            ...
                            <h1 class="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-none">
                                อนุมัติการเข้า<span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-orange-500">เปลี่ยนยาม</span>
                            </h1>
                        </div>
                        <p class="text-slate-500 font-medium text-lg max-w-2xl leading-relaxed ml-2 md:ml-[4.5rem]">
                            ขั้นตอนสุดท้ายในการพิจารณาอนุมัติคำขอเปลี่ยนเวรยาม หลังจากผ่านการเห็นชอบจากระดับฝ่ายการเจ้าหน้าที่และรองผู้อำนวยการเรียบร้อยแล้ว พร้อมลงลายมือชื่ออิเล็กทรอนิกส์ในฐานะ ผอ.
                        </p>
                    </div>
                ...
                <div v-if="!requests || requests.length === 0"
                    ...
                    <div class="w-40 h-40 bg-gradient-to-br from-rose-50 to-slate-50 rounded-full flex items-center justify-center mx-auto mb-10 shadow-inner group border border-white relative">
                        <div class="absolute inset-0 bg-rose-400/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
                        <i data-lucide="crown" class="w-20 h-20 text-rose-300 group-hover:scale-110 group-hover:text-rose-400 transition-all duration-700 relative z-10"></i>
                    </div>
                    <h3 class="text-3xl font-black text-slate-900 mb-4 tracking-tight">ไม่มีรายการค้างพิจารณา</h3>
                    <p class="text-slate-500 max-w-sm mx-auto text-lg font-medium">ทุกรายการได้รับการตัดสินใจขั้นสุดท้ายโดยท่านเรียบร้อยแล้ว</p>
                </div>

                <!-- Request Cards -->
                <div v-else class="grid grid-cols-1 gap-8 mb-12">
                    <div v-for="(req, index) in requests" :key="req.id"
                         class="glass-card rounded-[2.5rem] p-8 md:p-10 hover:shadow-xl hover:shadow-rose-500/10 transition-all duration-500 relative overflow-hidden group/card"
                        ...
                        <div class="absolute top-0 right-0 w-80 h-80 bg-gradient-to-bl from-rose-100/40 to-transparent rounded-bl-full -mr-20 -mt-20 opacity-0 group-hover/card:opacity-100 transition-all duration-1000 pointer-events-none group-hover/card:scale-110"></div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-10 lg:gap-14 relative z-10">
                            ...
                            <div class="flex-shrink-0 flex flex-row lg:flex-col items-center lg:items-start gap-6 lg:w-[15rem] min-w-0 pb-6 lg:pb-0 border-b lg:border-b-0 lg:border-r border-slate-200/60 lg:pr-10">
                                <div class="relative">
                                    <div class="w-24 h-24 lg:w-28 lg:h-28 rounded-[2rem] bg-gradient-to-br from-rose-50 to-white text-rose-400 flex items-center justify-center text-4xl font-black shadow-lg overflow-hidden border-4 border-white">
                                    ...
                                    <div class="absolute -bottom-2 -right-2 w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-rose-500 to-orange-600 rounded-xl flex items-center justify-center text-white shadow-lg border-2 border-white transform rotate-6 group-hover/card:-rotate-6 transition-transform duration-500">
                                        <i data-lucide="crown" class="w-4 h-4 lg:w-5 lg:h-5"></i>
                                    </div>
                                </div>
                                <div class="flex-1 lg:flex-none flex flex-wrap items-center lg:items-start lg:flex-col gap-2 min-w-0 max-w-full overflow-hidden">
                                    <h4 class="text-xl font-black text-slate-900 leading-tight tracking-tight truncate w-full group-hover/card:text-rose-700 transition-colors">{{ req.user?.rank }}{{ req.user?.name }}</h4>
                                    <span class="text-[10px] font-black text-rose-600 uppercase tracking-[0.2em] bg-rose-50 border border-rose-100/50 px-3 py-1 rounded-full whitespace-nowrap">ผู้ขอเปลี่ยนเวร</span>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-6">
                                    ...
                                    <span class="inline-flex items-center gap-2 px-4 py-2 bg-rose-50/80 border border-rose-200 text-rose-700 rounded-[1rem] text-xs font-black shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="bg-white/60 rounded-[1.5rem] p-6 border border-white relative group/quote shadow-sm">
                                        <i data-lucide="message-square" class="absolute top-5 right-5 w-8 h-8 text-slate-100 group-hover/quote:text-rose-100 transition-colors"></i>
                                    ...
                                    <!-- Approval Chain Info -->
                                    <div class="col-span-1 md:col-span-2 bg-amber-50/50 rounded-[1.5rem] p-5 border border-amber-100 flex items-start gap-4 shadow-inner">
                                        <div class="w-10 h-10 rounded-xl bg-amber-100 text-amber-500 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm border border-white">
                                            <i data-lucide="git-commit" class="w-5 h-5"></i>
                                        </div>
                                        <div class="flex-1">
                                            <div class="flex justify-between items-start">
                                                <div>
                                                    <p class="text-[10px] font-black text-amber-400 uppercase tracking-widest mb-0.5">สถานะปัจจุบัน</p>
                                                    <p class="text-[13px] font-black text-amber-700 break-words pr-4">รอการอนุมัติขั้นสุดท้าย (ผอ.)</p>
                                                </div>
                                            </div>
                                            <div class="mt-3 text-[11px] font-medium text-slate-500 pl-3 border-l-2 border-amber-200">
                                                <span class="font-bold text-slate-600 block mb-1">ความเห็น รอง ผอ.:</span>
                                                "{{ req.director_comment || 'ไม่มีการให้เหตุผลเพิ่มเติม' }}"
                                                <span class="text-slate-400 block mt-1">(รอง ผอ. เห็นชอบเมื่อ {{ req.director_approved_at ? formatShortDate(req.director_approved_at) : '-' }})</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex-shrink-0 lg:w-[15rem] flex flex-row lg:flex-col justify-center items-center gap-4 lg:pl-10 lg:border-l border-slate-200/60 pt-6 lg:pt-0 border-t lg:border-t-0">
                                <button @click="openApprove(req)"
                                    class="flex-1 lg:flex-none w-full group/btn relative px-6 py-4 lg:py-5 bg-gradient-to-r from-rose-500 to-orange-600 text-white rounded-[1.5rem] shadow-lg shadow-rose-500/20 hover:shadow-rose-500/40 transition-all hover:-translate-y-1 overflow-hidden border border-rose-400/50">
                                    <div class="absolute inset-0 bg-gradient-to-r from-rose-600 to-orange-700 opacity-0 group-hover/btn:opacity-100 transition-opacity"></div>
                                    <div class="relative flex items-center justify-center gap-2.5">
                                        <i data-lucide="crown" class="w-5 h-5 group-hover/btn:scale-110 transition-transform"></i>
                            ...
                            <form @submit.prevent="submit">
                                <div class="p-8 md:p-10">
                                    <div class="flex items-start justify-between mb-8">
                                        <div class="w-14 h-14 rounded-[1.2rem] bg-rose-50 text-rose-600 flex items-center justify-center shadow-inner">
                                    ...
                                    <h3 class="text-2xl font-black text-slate-900 tracking-tight mb-2">ยืนยันการอนุมัติ <span class="text-rose-600">(ผอ.)</span></h3>
                                    <p class="text-slate-500 font-medium mb-6 text-sm">พิจารณาอนุมัติขั้นสุดท้ายคำขอเปลี่ยนยามของ <span class="font-black text-rose-600">{{ activeReq?.user?.rank }}{{ activeReq?.user?.name }}</span></p>

                                    <div class="mb-6 p-4 bg-white rounded-2xl border border-rose-100/50 shadow-sm flex items-center gap-4">
                                        <div class="w-10 h-10 bg-rose-50 rounded-xl flex items-center justify-center text-rose-500 flex-shrink-0">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="flex gap-2 mb-4 bg-slate-100 p-1.5 rounded-2xl">
                                            <button type="button" @click="switchSignatureMode('saved')"
                                                :class="signatureMode === 'saved' ? 'bg-white text-rose-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'"
                                            ...
                                            <button type="button" @click="switchSignatureMode('draw')"
                                                :class="signatureMode === 'draw' ? 'bg-white text-rose-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'"
                                                class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-[1.1rem] text-xs font-black uppercase tracking-wider transition-all">
                                        ...
                                        <div v-if="signatureMode === 'saved'">
                                            <div v-if="savedSignatureUrl" class="relative bg-white border border-rose-100 shadow-inner rounded-2xl p-6 flex flex-col items-center justify-center min-h-[140px]">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <textarea v-model="form.comment" rows="2"
                                            class="block w-full rounded-2xl border-slate-200 bg-white shadow-inner focus:bg-white focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all text-sm font-bold text-slate-700 placeholder:text-slate-300 resize-none"
                                ...
                                <div class="bg-white/80 border-t border-slate-100 p-6 md:px-10 flex flex-col sm:flex-row-reverse gap-3">
                                    <button type="submit" :disabled="form.processing || (signatureMode === 'saved' && !savedSignatureUrl && signatureMode !== 'draw')"
                                        class="flex-1 inline-flex justify-center items-center px-8 py-4 bg-rose-600 hover:bg-rose-700 text-white font-black uppercase tracking-widest text-xs rounded-[1.2rem] shadow-lg shadow-rose-500/30 transition-all hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0">
                                        <i data-lucide="crown" class="w-4 h-4 mr-2"></i>
                                        {{ form.processing ? 'กำลังดำเนินการ...' : 'ยืนยันการอนุมัติ (ผอ.)' }}
                                    </button>
