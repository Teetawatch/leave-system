<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto pb-12">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h2 class="text-3xl font-black text-slate-800 tracking-tight">เพิ่มข้าราชการใหม่</h2>
                <p class="text-slate-500 mt-1">ลงทะเบียนและกำหนดสิทธิ์การใช้งานระบบสำหรับบุคลากรใหม่</p>
            </div>
                            ...
                            <div class="relative group">
                                ...
                                <select name="rank" required
                                    ...
                                    @foreach(['น.อ.', 'น.ท.', 'น.ต.', 'น.ต.หญิง', 'ร.อ.', 'ร.ท.', 'ร.ต.', 'พ.จ.อ.', 'พ.จ.ท.', 'พ.จ.ต.', 'จ.อ.', 'จ.ท.', 'จ.ท.หญิง', 'จ.ต.', 'นาย', 'นางสาว',] as $rank)
                                        <option value="{{ $rank }}" {{ old('rank') == $rank ? 'selected' : '' }}>{{ $rank }}
                                        </option>
                                    @endforeach
                                </select>
                                <div
            ...
            <div
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <!-- Password -->
                        <div class="space-y-2">
                            <label class="block text-sm font-black text-slate-700 ml-1">รหัสผ่าน <span
                                    class="text-rose-500">*</span></label>
                            <div class="relative group">
                                <div
                                    class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-brand-500 transition-colors">
                            ...
                            @error('password') <p
                                class="mt-1 text-xs text-rose-500 font-medium flex items-center gap-1"><i
                            data-lucide="alert-circle" class="w-3 h-3"></i> {{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <select name="role" required
                                    class="block w-full pl-11 pr-4 py-3 rounded-2xl border-slate-200 bg-slate-50/30 focus:bg-white focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all appearance-none cursor-pointer text-slate-700 font-medium">
                                    <option value="employee" {{ old('role') == 'employee' ? 'selected' : '' }}>ข้าราชการ
                                    </option>
                                    <option value="department_head" {{ old('role') == 'department_head' ? 'selected' : '' }}>หัวหน้าแผนก</option>
                                    <option value="deputy_director" {{ old('role') == 'deputy_director' ? 'selected' : '' }}>รอง ผอ.รพธ.พธ.ทร.</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-2">
                            ...
                            <p class="text-[11px] text-slate-400 mt-1 ml-1 leading-relaxed">
                                กำหนดจำนวนวันลาพักผ่อนที่ได้รับสิทธิ์ต่อปี (สามารถแก้ไขได้ภายหลัง)</p>
                        </div>
                    </div>
                </div>
            </div>
