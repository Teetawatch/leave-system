...
return [
    ...
    */
    ...
    'public_path' => (function() {
        // Try multiple paths for different hosting environments
        $paths = [
            base_path('public'),
            dirname(base_path()) . '/public_html',
            dirname(base_path()) . '/public',
            // Shared hosting specific paths (nass.ac.th)
            dirname(dirname(base_path())) . '/public_html',
            str_replace('/face-core', '/public_html', base_path()),
            str_replace('/face-core', '', base_path()),
        ...
        // Fallback to base_path('public') even if it doesn't exist (for new installations)
